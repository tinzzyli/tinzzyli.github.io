...
<div class="row justify-content-center" style="max-width: 50%; height: auto;"> <!-- Center the row -->
    <div class="col-sm mt-12 mt-md-0 text-center" style="max-width: 50%; height: auto;"> <!-- Center the column content -->
